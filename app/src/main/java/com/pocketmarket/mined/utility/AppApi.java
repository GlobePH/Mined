...
public class AppApi {
    ...
    public static final String URL_NAME = "http://192.168.169.138:8080/MinedRest";
    ...
    // Channels
    public static final String CHANNEL = "/u/channelservice";
    public static final String CHANNELS_INFO = "/u/channelservice?accesstoken=";
    public static final String CHANNELS_JOIN = "/u/channeljoinservice?accesstoken=";
    public static final String CHANNELS_USER_JOIN = "/u/channeluserjoinedservice?accesstoken=";
    public static final String CHANNELS_MARK_AS_MAIN = "/u/channelmarkasmainservice?accesstoken=";


    // Rooms
    public static final String CHANNEL_ROOMS = "/u/channelroomsservice?accesstoken=";
    public static final String CHANNEL_ROOMS_ID = "&channelid=";
