...
//                mAssistantFragmentManager.uploadImage(mCurrentPhotoPath);
    ...
    private void paypalPayments(){
        ...
        i.putExtra("id", 1);
        i.putExtra("name", "Globe Registration");
        i.putExtra("description", "Globe Registration");
        i.putExtra("photo", "https://s3-us-west-2.amazonaws.com/others-akiain5bkt5id6lqouoa-1/globe.png");
