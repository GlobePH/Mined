...
public class ApplicationFragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mSalutation = mUploadedForm.getUser().getSalutation();

        mGender = mUploadedForm.getUser().getGender();

        mBirthdate = mUploadedForm.getBirthDate();

        mHomeOwnership = mUploadedForm.getOwnerShip().getHomeOwnerShip();

        mHomeOwnershipYears = mUploadedForm.getOwnerShip().getHomeOwnerShipYears();

        mHomeOwnershipSalary = mUploadedForm.getOwnerShip().getHomeOwnerShipSalary();
    ...
    private void updateUploadedForms(){
        ...
        user.setMonth(birthdate.substring(0,1));
        user.setDay(birthdate.substring(2,3));
        user.setYear(birthdate.substring(4,5));
